...
<head>
    ...
    <link href="<?= base_url('assets/landing/') ?>css/tooplate-tween-agency.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand">
                <i class="bi-layers"></i> East Blue Tech
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-lg-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#section_2">Tentang</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#section_3">Layanan</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#section_4">Project Kami</a>
                    </li>
    ...
    <main>
                    ...
                    <div class="col-12">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-intro" role="tabpanel" aria-labelledby="nav-intro-tab">
                                <div class="row">
                                    <div class="col-lg-6 col-12 mb-lg-0 mb-4">
                                        <img src="<?= base_url('assets/landing/') ?>images/webpage-browser-digital-icon-symbols-concept.jpg" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12 mt-lg-0 mt-4">
                                        <img src="<?= base_url('assets/landing/') ?>images/dream-about-working-corporation-became-true.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="nav-faq" role="tabpanel" aria-labelledby="nav-faq-tab">
                                <div class="row">
                                    <div class="col-lg-6 col-12 mb-lg-0 mb-4">
                                        <img src="<?= base_url('assets/landing/') ?>images/php-programming-html-coding-cyberspace-concept.jpg" class="img-fluid" alt="">
                                    </div>
        ...
        <section class="services section-padding" id="section_3">
            <div class="container">
                <div class="row">
                    ...
                    <h2 class="mb-5 text-center">Layanan Digital</h2>

                    <div class="col-lg-4 col-12 d-flex bg-primary p-0">
                        <img src="<?= base_url('assets/landing/') ?>images/services/undraw_Online_page_re_lhgx.svg" class="img-fluid services-image" alt="">
                    </div>
                    ...
                    <div class="col-lg-4 col-12 d-flex bg-warning p-0">
                        <img src="<?= base_url('assets/landing/') ?>images/services/undraw_online_transactions_02ka.svg" class="img-fluid services-image" alt="">
                    </div>
                    ...
                    <div class="col-lg-4 col-12 d-flex bg-success p-0 order-lg-0 order-sm-4">
                        <img src="<?= base_url('assets/landing/') ?>images/services/undraw_content_team_3epn.svg" class="img-fluid services-image" alt="">
                    </div>
        ...
        <section class="work section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="mb-5 text-center">Project Pilihan</h2>
                    </div>

                    <div class="col-lg-4 col-12">
                        <div class="work-thumb mb-4">
                            <div class="work-image-wrap">
                                <a href="<?= base_url('assets/landing/') ?>images/work/anthony-espinosa-pYQSM-p_0_c-unsplash.jpg" class="image-popup">
                                    <img src="<?= base_url('assets/landing/') ?>images/work/anthony-espinosa-pYQSM-p_0_c-unsplash.jpg" class="img-fluid work-image" alt="">
                                </a>
                            </div>
                        ...
                        <div class="work-thumb mb-4">
                            <div class="work-image-wrap">
                                <a href="<?= base_url('assets/landing/') ?>images/work/samantha-gades-lf2pD--wIUA-unsplash.jpg" class="image-popup">
                                    <img src="<?= base_url('assets/landing/') ?>images/work/samantha-gades-lf2pD--wIUA-unsplash.jpg" class="img-fluid work-image" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="work-thumb mb-4">
                            <div class="work-image-wrap">
                                <a href="<?= base_url('assets/landing/') ?>images/work/business-chart-visual-graphics-report-concept.jpg" class="image-popup">
                                    <img src="<?= base_url('assets/landing/') ?>images/work/business-chart-visual-graphics-report-concept.jpg" class="img-fluid work-image" alt="">
                                </a>
                            </div>
                        ...
                        <div class="work-thumb mb-4">
                            <div class="work-image-wrap">
                                <a href="<?= base_url('assets/landing/') ?>images/work/tyler-nix-HmVQh_EQJhY-unsplash.jpg" class="image-popup">
                                    <img src="<?= base_url('assets/landing/') ?>images/work/tyler-nix-HmVQh_EQJhY-unsplash.jpg" class="img-fluid work-image" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="work-thumb mb-4">
                            <div class="work-image-wrap">
                                <a href="<?= base_url('assets/landing/') ?>images/work/mos-sukjaroenkraisri-jz8AmJDyhig-unsplash.jpg" class="image-popup">
                                    <img src="<?= base_url('assets/landing/') ?>images/work/mos-sukjaroenkraisri-jz8AmJDyhig-unsplash.jpg" class="img-fluid work-image" alt="">
                                </a>
                            </div>
        ...
        <section class="pricing section-padding" id="section_5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h2 class="text-white mb-5 text-center">Harga Untuk Tiap Kateg</h2>
                    </div>
    ...
    <script src="<?= base_url('assets/landing/') ?>js/jquery.backstretch.min.js"></script>
    <script src="<?= base_url('assets/landing/') ?>js/jquery.magnific-popup.min.js"></script>
    <script src="<?= base_url('assets/landing/') ?>js/magnific-popup-options.js"></script>
    <script src="<?= base_url('assets/landing/') ?>js/click-scroll.js"></script>
