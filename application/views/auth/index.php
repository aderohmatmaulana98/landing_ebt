        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center pt-3 pb-3">
                    <span class="db"><img src="<?= base_url('assets') ?>/img/logo.png" alt="logo" width="100" /></span>
                    <div class="mt-4 mb-0">
                    ...
                    <div class="row pb-4">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" placeholder="Email Address" aria-label="email" name="email" id="email" aria-describedby="basic-addon1" required="" />
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Password" aria-label="Password" name="password" id="password" aria-describedby="basic-addon1" required="" />
